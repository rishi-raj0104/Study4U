...
const About = () => {
  return (
    <div>
        ...
        <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-richblack-900">
          <header className="mx-auto py-20 text-4xl font-semibold lg:w-[70%]">
            ...
            <p className="mx-auto mt-3 text-center text-base font-medium text-richblack-700 lg:w-[95%]">
              Study4U is at the forefront of driving innovation in online
      ...
      <div className="relative mx-auto my-20 flex w-11/12 max-w-5xl flex-col items-center justify-between gap-6 md:gap-8 overflow-hidden px-4 md:px-8">
