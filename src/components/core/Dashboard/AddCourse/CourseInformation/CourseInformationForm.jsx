...
export default function CourseInformationForm() {
  ...
  return (
    <form
      ...
      className="space-y-8 rounded-md border-[1px] border-richblack-900 bg-yellow-300 p-6"
    >
      {/* Course Title */}
      ...
      <div className="flex justify-end gap-x-2">
        {editCourse && (
          <button
            ...
            disabled={loading}
            className={`flex cursor-pointer items-center gap-x-2 rounded-md bg-richblack-900 py-[8px] px-[20px] font-semibold text-richblack-900`}
          >
