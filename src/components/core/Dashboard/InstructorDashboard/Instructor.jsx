    ...
    return (
      <div className="p-4 sm:p-6 md:p-8">
        <div className="space-y-2 text-center sm:text-left">
          ...
          <p className="font-medium text-richblack-900">Let's start something new</p>
        </div>
        {loading ? (
          ...
          <div className="mt-6 space-y-6">
            <div className="flex flex-col md:flex-row md:space-x-4">
              {totalAmount > 0 || totalStudents > 0 ? (
                <InstructorChart courses={instructorData} className="w-full md:w-2/3" />
              ) : (
              ...
              <div className="mt-4 md:mt-0 flex flex-col items-center md:items-start rounded-md bg-richblack-800 p-6 min-w-[250px]">
