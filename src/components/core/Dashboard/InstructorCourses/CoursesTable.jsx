...
export default function CoursesTable({ courses, setCourses }) {
  ...
  return (
    <>
      <Table className="rounded-xl border border-richblack-900 bg-yellow-300 ">
        <Thead>
              ...
              >
                <Td className="flex flex-1 gap-x-4">
                  ...
                  <div className="flex flex-col justify-between">
                    ...
                    <p className="text-[12px] text-richblack-900">
                ...
                <Td className="text-sm font-medium text-richblack-900 ">
                  <button
                    ...
                    title="Edit"
                    className="px-2 transition-all duration-200 hover:scale-110 hover:text-caribbeangreen-300 hover:bg-richblack-900 hover:rounded-full"
                  >
                    <FiEdit2 size={20} />
                  </button>
                  <button
                    ...
                    title="Delete"
                    className="px-1 transition-all duration-200 hover:scale-110 hover:text-[#ff0000] hover:bg-richblack-900 hover:rounded-full"
                  >
